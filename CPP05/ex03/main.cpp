...
/*   Updated: 2022/07/28 19:15:02 by aessakhi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	Intern	intern;
	Form *form = intern.makeForm("Presidential pardon", "Random dude");
	Form *shrubbery = intern.makeForm("Shrubbery creation", "Random_Garden");
	Form *robotomy = intern.makeForm("Robotomy request", "Random Robot");
	Form *invalid = intern.makeForm("Invalid form", "Random Robot");
	std::cout << std::endl;
